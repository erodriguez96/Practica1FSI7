...
class OpenList(Queue):
    ...
    def append(self, item):
        self.A.append(item)
        # Crea una funcion lambda que tratara cada uno de los nodos del vector (que ahora mismo se llamaran X. Lo que
        # hara el metodo es devolver el path cost de cada uno de los elementos y ordenar segun este valor.
